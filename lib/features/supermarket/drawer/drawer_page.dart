...
import 'sidebar_controller.dart'; // استيراد المتحكم الخاص بالسوبر ماركت
...
class DrawerPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // التأكد من العثور على SidebarController الخاص بالسوبر ماركت
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ListTile(
                title: Text(
                  "menu".tr, // تغيير من admin_menu إلى menu عامة أو supermarket_menu
