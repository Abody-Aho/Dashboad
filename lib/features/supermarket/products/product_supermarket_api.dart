...
import '../../../data/models/product_supermarket_model.dart';
...
mixin ProductSupermarketApi on GetxController {
  ...
  Future<void> searchQuery(String query) async {
    ...
    try {
      ...
      final superId = controller.auth.currentUser.value!.id;
  ...
  Future<void> submitAddProduct() async {
    ...
    if (controller.selectedCategoryAllId.value == null) {
      Get.snackbar(
        "تنبيه",
    ...
    try {
      // إنشاء مودل الإضافة
      final product = AddSupermarketProductModel(
        ...
        superId: controller.auth.currentUser.value!.id!,
      ...
      request.fields.addAll({
        ...
        "supermarket_id": product.superId.toString(),
      });
  ...
  Future<void> submitUpdateProduct(int id) async {
    ...
    try {
      ...
      request.fields.addAll({
        ...
        "super": controller.auth.currentUser.value!.id.toString(),
      });
