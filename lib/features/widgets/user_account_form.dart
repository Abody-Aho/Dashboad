...
class UserAccountForm extends StatelessWidget {
      ...
      return Column(
        children: [
          ...
          DropdownButtonFormField<String>(
            initialValue: role,
            hint: Text("choose".tr, style: const TextStyle(color: Colors.green)),
            ...
            items: controller.roles.map<DropdownMenuItem<String>>((roleItem) {
              return DropdownMenuItem<String>(
                ...
                child: Row(
                  children: [
                    Icon(roleItem['icon'] as IconData, color: roleItem['color'] as Color),
          ...
          if (role == 'supermarket') ...[
            ...
            _buildTextField(
              ...
              validator: (v) => v!.isEmpty ? "الاسم العربي مطلوب للسوبرماركت" : null,
            ),
          ],
          ...
          if (role == 'admin' || role == 'supermarket') ...[
            _buildTextField(
              ...
              icon: Icons.email,
              validator: (v) => v == null || v.isEmpty ? "email_required".tr : (!GetUtils.isEmail(v) ? "email_invalid".tr : null),
            ),
            const SizedBox(height: 20),
          ],
          ...
          _buildTextField(
            ...
            validator: (v) => (v == null || v.isEmpty) ? "phone_required".tr : (v.length < 9 ? "must_be_9_number".tr : null),
          ),
    ...
    return Column(
      children: [
        ...
        TextFormField(
          ...
          validator: validator ?? (v) => v!.isEmpty ? "field_required".tr : null,
        ),
      ],
    );
  }
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: _inputDecoration(
            ...
            suffix: IconButton(
              icon: Icon(visibleObs.value ? Icons.visibility : Icons.visibility_off, color: Colors.green),
              onPressed: () => visibleObs.toggle(),
            ),
          ),
          validator: (v) {
            if (v == null || v.isEmpty) return "password_required".tr;
            if (isConfirm && v != controller.passwordController.text) return "password_not_match".tr;
            return null;
          },
        ),
      ],
  ...
  InputDecoration _inputDecoration({String? hint, IconData? icon, Widget? suffix}) {
    return InputDecoration(
      enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(15), borderSide: const BorderSide(color: Colors.green, width: 1.5)),
      focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(15), borderSide: const BorderSide(color: Colors.green, width: 2.5)),
      hintText: hint,
